void main() {
  Set mySet = {"A", "B", "C", "D", "F"};
  Set mySetTwo = {5, 10, 15, 20, 3.1416};
...
/* In Dart, you can use the "where" method to filter a set and create a new set that 
 only contains elements that meet a specific condition.*/
//
  var finalResult = mySet;
  print(finalResult);
  print(result);
}
